...
class SurfaceBenchmark(zntrack.Node):
    ...
    def benchmark_precompute(
        ...
        # OC157
        OC157_mae_df = pd.read_pickle(os.path.join(cache_dir, "mae_df.pkl"))
        OC157_rel_df_all = pd.read_pickle(os.path.join(cache_dir, "rel_energy_df.pkl"))
        OC157_dft_df = pd.read_pickle(os.path.join(cache_dir, "dft_df.pkl"))
        
        
        
        benchmark_score_df = SurfaceBenchmark.sur_benchmark_score(
            wtmad_df_GMTKN55=wtmad_df_GMTKN55,
            stats_df_HD=stats_df_HD,
            wig150_mae_df=wig150_mae_df if Wiggle150_data else None,
            normalise_to_model=normalise_to_model,
