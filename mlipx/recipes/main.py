...
def create_benchmark_command(template_file: str, category_benchmark: bool = False):
    ...
    def command(
        ...
        repro: bool = False,
        datapath: str | None = None,
        md_datapath: str | None = None,
        neb_datapath: str | None = None,
        material_ids: str | None = None,
        smiles: str | None = None,
        models: t.Annotated[str | None, typer.Option()] = None,
        steps: int = 1000,
        temperature: int = 300,
        md_write_frames_every: int = 10,
        ...
        ray: bool = False,
        mp_ids_done: str | None = None,
        array_chunk_size: int | None = None,
        ...
        kwargs = dict(
            ...
            md_write_frames_every=md_write_frames_every,
            n_jobs=n_jobs,
